interface ZIF_BAPI_EPM_SO_GET_LIST
  public .
  ...
  types:
    begin of BAPI_EPM_CUSTOMER_NAME_RANGE,
      SIGN type BAPISIGN,
      OPTION type BAPIOPTION,
      LOW type SNWD_COMPANY_NAME,
      HIGH type SNWD_COMPANY_NAME,
    end of BAPI_EPM_CUSTOMER_NAME_RANGE .
  types:
    __BAPI_EPM_CUSTOMER_NAME_RANGE type standard table of BAPI_EPM_CUSTOMER_NAME_RANGE   with non-unique default key .
  types:
    SNWD_PRODUCT_ID type C length 000010 .
  types:
    begin of BAPI_EPM_PRODUCT_ID_RANGE,
      SIGN type BAPISIGN,
      OPTION type BAPIOPTION,
      LOW type SNWD_PRODUCT_ID,
      HIGH type SNWD_PRODUCT_ID,
    end of BAPI_EPM_PRODUCT_ID_RANGE .
  types:
    __BAPI_EPM_PRODUCT_ID_RANGE    type standard table of BAPI_EPM_PRODUCT_ID_RANGE      with non-unique default key .
  types:
    SNWD_SO_ID type C length 000010 .
  types:
    begin of BAPI_EPM_SO_ID_RANGE,
      SIGN type BAPISIGN,
      OPTION type BAPIOPTION,
      LOW type SNWD_SO_ID,
      HIGH type SNWD_SO_ID,
    end of BAPI_EPM_SO_ID_RANGE .
  types:
    __BAPI_EPM_SO_ID_RANGE         type standard table of BAPI_EPM_SO_ID_RANGE           with non-unique default key .
  types:
  ...
  types:
    __BAPI_EPM_SO_HEADER           type standard table of BAPI_EPM_SO_HEADER             with non-unique default key .
  types:
